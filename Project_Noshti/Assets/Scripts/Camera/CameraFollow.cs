...
public class CameraFollow : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        Vector3 newLocation = (Vector3)focusPosition + Vector3.forward * -10;
        Vector3 translation = newLocation - transform.position;

        //newLocation is a position. We need the difference between the focus position and our current position.
